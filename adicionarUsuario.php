...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql = "INSERT INTO usuario (nombre_usuario, contraseña, e_mail, tipo_usuario) VALUES('$nombre_usuario','$contraseña', '$e_mail','$tipo_usuario')" ;
...
<body>
    ...
    <br>
    <a href="MostarUsuario.php">Ver lista de Usuarios</a>
</body>
</html>