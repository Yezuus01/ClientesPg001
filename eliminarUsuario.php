...
if (isset($_POST['eliminar']) && isset($_POST['id'])) {
    ...
    if (!empty($ids_a_eliminar)) {
        ...
        $sql_delete ="DELETE FROM usuario WHERE id_usuario IN ($lista_ids)";
...
<body>
    ...
    <br>
    <a href="MostarUsuario.php">Volver a lista de usuarios</a> | <a href="AdicionarUsuario.php">Adicionar Nuevo Usuario</a>
</body>
</html>
