...
if (isset($_POST['guardar'])) {
    ...
    $sql_update = "UPDATE clientesdb SET nombres= '$nombres', apellido_paterno='$apellido_paterno', apellido_materno='$apellido_materno', ci='$ci', direccion='$direccion' WHERE id_clientes='$id'";
