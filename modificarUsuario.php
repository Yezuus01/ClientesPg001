...
if (isset($_POST['guardar'])) {
    ...
    $sql_update = "UPDATE usuario SET nombre_usuario= '$nombre_usuario', contraseña='$contraseña', e_mail='$e_mail', tipo_usuario='$tipo_usuario' WHERE id_usuario='$id'";
...
if (isset($_POST['modificar'])) {
    if(isset($_POST['ids']) && count($_POST['ids']) == 1) {
        ...
        $sql_buscar = "SELECT * FROM usuario WHERE id_usuario='$id_editar'";
...
$sql_lista = "SELECT * FROM usuario $where";
...
<body>
    ...
    <br>
    <a href="MostarUsuario.php">Volver a lista de usuarios</a> | <a href="AdicionarUsuario.php">Adicionar</a> | <a href="EliminarUsuario.php">Eliminar</a>
</body>
</html>
